                    ...
                    <div class="post-content">
                        <div class="post-container">
                            ...
                            <div class="post-detail">
                                ...
                                <div class="reaction">
                                <form method="post" action="{{route('like.create', ['post_id' => $post->id])}}">
                                    @csrf
                                    <button class="btn text-green" name = "like"><i class="fa fa-thumbs-up" ></i> {{$post->likes}}</button>
                                    <button class="btn text-red"  name = "dislike"><i class="fa fa-thumbs-down" ></i>{{$post->dislikes}} </button>
                                </form>
